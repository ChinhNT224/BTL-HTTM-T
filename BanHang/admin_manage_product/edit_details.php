...
<html>
    ...
    <?php
        if(isset($ex_cid)){
            $s = "SELECT * FROM `product` WHERE CategoryID = '$ex_cid'";
                ...
                <div class="content">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="codeP" value="<?php echo $pd['ProductID']; ?>" required>
                            </div>
                            <div class="form-group">
                                <span class=""> Số lượng</span>
                                <input type="number" name="quantity" value="<?php echo $pd['ProductQuantity']; ?>"></input>
                            </div>
                            <div class="form-group">
                                <span class=""> Giá</span>
                                <input type="number" name="price" value="<?php echo $pd['Price']; ?>"></input>
                            </div>
                            <!-- save -->
                            <div class="form-group">
                    ...
                    if(isset($_POST['submit'])){
                        ...
                        elseif (!preg_match('/^[0-9]+$/', $price)) {
                            ...
                            $sql3 = "DELETE FROM product WHERE CategoryID = '$ex_cid'";
                            $sql4 = "DELETE FROM categories WHERE CategoryID = '$ex_cid'";
                            $query3 = mysqli_query($con, $sql3);
                            $query4 = mysqli_query($con, $sql4);
                            echo "<script> alert('Sản Phẩm Đã Được Sửa');
